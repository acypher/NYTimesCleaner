#!/usr/bin/env python3
"""Bump NewsMinus semver and sync manifest + Safari Xcode project files."""
...
PBXPROJ = ROOT / "safari" / "NYTimesCleanerSafari.xcodeproj" / "project.pbxproj"
...
def regenerate_pbxproj() -> None:
    subprocess.run([sys.executable, str(GEN_PBX)], check=True, cwd=ROOT)


def main() -> int:
    parser = argparse.ArgumentParser(description="Bump NewsMinus version across release files.")
